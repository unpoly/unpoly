...
up.Change.Addition = class Addition extends up.Change {
  ...
  executeSteps({ steps, responseDoc, result, noneOptions, passRenderOptions = this.options }) {
    return new up.Change.UpdateSteps({ steps, noneOptions, passRenderOptions }).execute(responseDoc, result)
  }
