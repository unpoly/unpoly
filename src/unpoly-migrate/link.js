...
up.migrate.renamedAttribute('up-closable', 'up-dismissible', { scope: followSelectorFn })
up.migrate.renamedAttribute('up-dismissable', 'up-dismissible', { scope: followSelectorFn })
