...
- The up:fragment:kept event was removed. There is still `up:fragment:keep`.
...
- The legacy documentation for Unpoly 2.x has been archived to https://v2.unpoly.com.
