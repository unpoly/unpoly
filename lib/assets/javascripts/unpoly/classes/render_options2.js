...
//      PRELOAD_OVERRIDES
//
//  preprocess = (userOptions) ->
//    up.migrate.handleRenderOptions?(userOptions)
//
//    if options.preload
//      userOptions = u.merge(userOptions, PRELOAD_OVERRIDES)
//
//    defaults = u.merge(
//      GLOBAL_DEFAULTS,
//      navigateDefaults(userOptions),
//    )
//
//    # Create an object that both inherits from defaults
//    # and can access its default options.
//    renderOptions = Object.create(defaults, { defaults })
//
//    return result
//
//  create = (defaults, userOptions) ->
//    Object.create(defaults, userOptions)
//    result.defaults = defaults
//    result
//
//  merge = (renderOptions, overrides) ->
//    return Object.create(renderOptions.defaults, u.merge(renderOptions, overrides))
//
//  deriveFailOptions = (renderOptions) ->
//
//    defaults = u.merge(
//      GLOBAL_DEFAULTS,
//      pickSharedPlusFailOverrides(navigateDefaults(renderOptions))
//    )
//
//    userOptions = u.merge(
//      pickSharedPlusFailOverrides(renderOptions),
//      preloadOverrides(renderOptions)
//    )
//
//    return Object.create(defaults, u.merge(userOptions, { defaults })
//
//  pickSharedPlusFailOverrides = (options) ->
//    u.merge(
//      u.pick(options, SHARED_KEYS),
