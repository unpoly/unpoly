...
###
up.link.targetMacro('up-modal', { 'up-layer': 'modal' }, -> up.migrate.deprecated('a[up-modal]', 'a[up-layer=modal]'))
...
###
up.link.targetMacro('up-drawer', { 'up-layer': 'drawer' }, -> up.migrate.deprecated('a[up-drawer]', 'a[up-layer=drawer]'))
