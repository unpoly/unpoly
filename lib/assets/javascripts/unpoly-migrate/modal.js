...
up.modal = u.literal({
  ...
  */
  visit(url, options = {}) {
    ...
    return up.layer.open(u.merge(options, { url, mode: 'modal' }));
  },
  ...
  */
  follow(link, options = {}) {
    ...
    return up.follow(link, u.merge(options, { layer: 'modal' }));
  },
  ...
  */
  extract(target, html, options = {}) {
    ...
    return up.layer.open(u.merge(options, { target, html, layer: 'modal' }));
  },
  ...
  */
  coveredUrl() {
    ...
    return (up.layer.parent != null ? up.layer.parent.location : undefined);
  },
