...
up.ajax = function(...args) {
  ...
  return up.request(...Array.from(args || [])).then(pickResponseText);
};
...
up.network.preload = function(...args) {
  ...
  return up.link.preload(...Array.from(args || []));
};
...
const mayHaveCustomIndicator = function() {
...
const disableProgressBarIfCustomIndicator = () => up.network.config.progressBar = function() {
