  ...
  describe('JavaScript functions', function() {
    ...
    describe('up.motion.finish()', function() {
      ...
      describe('when called without arguments', function() {
        ...
        it('cancels all animations on the screen', async function() {
    ...
    describe('up.morph()', function() {
      ...
      it('transitions between two elements that are already positioned absolutely', async function() {
        let timingTolerance
        const elementStyles = {
          position: 'absolute',
          left: '30px',
        ...
        await wait(100 + (timingTolerance = 120))
