...
describe('up.viewport', function() {
  ...
  describe('unobtrusive behavior', function() {
    ...
    describe('honoring obstructions when the location #hash changes', function() {

      describe('when the #hash is changed manually', function() {

        it('reveals a matching fragment', async function() {
      ...
      describe('when an a[href^="#"] is clicked', function() {

        it("reveals a fragment matching the link's hash", async function() {
          location.hash = ''
          await wait()
