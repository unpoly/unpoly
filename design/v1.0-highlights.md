...
**💡️ Polling is a much-requested feature. Userland implementations often don't handle slow connections, failed requests or hidden browser tabs.**
...
The `up.proxy` package has been renamed to `up.network`.
