...
up.fetch() no longer caches by default
========================================
...
You can fine-tune this if you want:
    ...
    up.request.config.preloadEnabled: 'auto'
    up.request.config.preloadTimeout: 10 * 1000
    up.request.config.preloadMaxResponseTime: 750
    up.request.config.preloadSampleSize: 3 // initial page load is first sample
...
E.g. up.on('up:proxy:load') will automatically bind to up:request:load
