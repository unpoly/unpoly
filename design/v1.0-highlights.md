...
In Unpoly 0.x and 1.0 event handlers may prevent these events to cancel the fragment.

[NEW] Unpoly 1.x lets event listeners change the options for the coming `render()` call:
