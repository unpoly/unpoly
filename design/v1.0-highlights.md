...
Most links only set one of the following:

- The main content area
- The component containing a link


Replacing the main content area
===============================
...
Unpoly 1.0 lets you define the default target in the DOM:
...
You no longer need [up-target] in a link:
...
## Different main targes for overlays
...
Instead of using [up-main] you may also configure in JS:

    up.layer.config.modal.targets.push('.layout--content')




Smarter choice of target
========================

The position of a clicked link is now considered when deciding which element to replace.

In this example we have two links that replace `.card`:

    <div class="card" id="card1">
      <a href="/cards/1" up-target=".card">Flip card #1</a>
    </div>

    <div class="card" id="card2">
      <a href="/cards/2" up-target=".card">Flip card #2</a>
    </div>

When clicking "Flip card #2", Unpoly 0.x would have replaced `.card`, matching the first card.

Unpoly 1.0 now replaces `.card#card2`, matching the second card.

Also the selector is improved when the matching element has a more specific selector.
...
=====================
    ...
    <div class="card" up-zone="card1">
      <a href="/cards/1" up-follow>Flip card #1</a>
    </div>

    <div class="card" up-zone="card2">
      <a href="/cards/2" up-follow>Flip card #2</a>
    </div>
...
Overlays no longer grow with their contents. All overlays now have set widths.
