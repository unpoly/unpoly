...
- In Unpoly 0.x overlay content always needed to know which element in a parent layer to target.
  ...
  This point is very important to me, since I think server-side code should mostly be unaware of Unpoly.
...
- In Unpoly 0.x it was very hard to communicate the "result" of an overlay interaction back to the parent layer.
  In Unpoly 1.0 a layer may have a result.
